...
if ($_GET) {
	$Kode = $_GET['code'];
	$mySql = "SELECT * FROM tb_karyawan WHERE nama_karyawan ='$Kode'";
		...
		<form id="theform" data-parsley-validate class="form-horizontal form-label-left" action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" id="nis" required="required" class="form-control col-md-7 col-xs-12" name="nama_karyawan" data-parsley-error-message="Field ini harus diisi" value="<?php echo $result['nama_karyawan']; ?>" readonly>
				</div>
			</div>
			<div class="form-group">
