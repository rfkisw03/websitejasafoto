				...
				<div class="user_profile_info">
					<div class="col-md-12 col-sm-10">
						<form method="post" name="sewa" onSubmit="return valid();">
							...
							<div class="form-group">
								<label>Down Payment (Dp)</label><br />
								<input type="text" class="form-control" name="dp" value="<?php echo format_rupiah($result['dp']); ?>" readonly>
							</div>
							<div class="form-group">
								<label>Status Pembayaran</label><br />
								<?php
								if ($result['stt_dp'] == "0" || $result['stt_dp'] == "1") { ?>
									<input type="text" class="form-control" name="stt_dp" value="BELUM LUNAS" readonly>
								<?php
								} else {
								?>
									<input type="text" class="form-control" name="stt_dp" value="LUNAS" readonly>
								<?php } ?>
							</div>
							...
							?>
								<b>*Silahkan transfer total biaya ke <?php echo $resultrek['detail']; ?> maksimal tanggal
