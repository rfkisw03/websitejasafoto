...
$ctkweb = mysqli_query($koneksidb, "select * from contactusinfo");
$w = mysqli_fetch_array($ctkweb);
				...
				<tbody>
					<tr>
						...
						<td class="text-center">
							<h3>PT. Dwipa Photowork</h3>
						</td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center">Phone : <?php echo $w['telp_kami'] ?>| E-mail : <?php echo $w['email_kami'] ?></td>
					</tr>
					<tr>
						<td class="text-center"><?php echo $w['alamat_kami'] ?></td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
			...
			<table class="table table-borderless">
				<tbody>
					...
					<tr>
						...
						<td>:</td>
						<td><?php echo format_rupiah($result['dp']); ?></td>
					</tr>
					<tr>
