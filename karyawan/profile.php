...
if (strlen($_SESSION['klogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		if ($file == "") {
			$con = "update tb_karyawan set nama_karyawan='$nama',
										telp = '$telp',
										alamat = '$alamat'
			...
			move_uploaded_file($_FILES["image"]["tmp_name"], "img/profil/" . $newimage);
			$con = "update tb_karyawan set nama_karyawan='$nama', profil='$newimage' where id_karyawan='$id'";
			$done = mysqli_query($koneksidb, $con);
			if ($done) {
				$msg = "Your Profile succesfully changed";
			} else {
										...
										<div class="panel-body">
											<form method="post" name="chngprfl" class="form-horizontal" onSubmit="return valid();" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" class="form-control" name="nama" id="nama" value=<?php echo $data['nama_karyawan']; ?> required>
														<input type="hidden" class="form-control" name="oldimage" id="oldimage" value=<?php echo $data['profil']; ?> required>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-4 control-label">telp</label>
													<div class="col-sm-8">
														<input type="number" class="form-control" name="telp" value=<?php echo $data['telp']; ?> required>
												...
												<div class="form-group">
													...
													<div class="col-sm-8">
														<img src="img/profil/<?php echo $data['profil'] ?>" width="100px">
													</div>
												</div>
												<div class="hr-dashed"></div>
