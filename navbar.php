                     ...
                     <li class="dropdown" bgcolor="blue"> <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user-circle" aria-hidden="true"></i>
                         ...
                         <ul class="dropdown-menu">
                             <?php if ($_SESSION['ulogin']) { ?>
                                 <li><a href="<?php echo $base_url ?>/profile.php">Profile Settings</a></li>
                                 <li><a href="<?php echo $base_url ?>/update-password.php">Update Password</a></li>
                                 <li><a href="<?php echo $base_url ?>/riwayatsewa.php">Riwayat Sewa</a></li>
