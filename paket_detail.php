...
<body>
  ...
  <?php
  $pkt = intval($_GET['pkt']);
  $sql = "SELECT * from paket WHERE id_paket='$pkt'";
  ...
  ?>
      ...
      <section id="listing_img_slider">
        <div><img src="image/paket/<?php echo htmlentities($result['foto_paket']); ?>" class="img-responsive" alt="image" width="900" height="560"></div>
        <div><img src="image/paket/<?php echo htmlentities($result['foto_paket']); ?>" class="img-responsive" alt="image" width="900" height="560"></div>
        <div><img src="image/paket/<?php echo htmlentities($result['foto_paket']); ?>" class="img-responsive" alt="image" width="900" height="560"></div>
        <div><img src="image/paket/<?php echo htmlentities($result['foto_paket']); ?>" class="img-responsive" alt="image" width="900" height="560"></div>
      </section>
